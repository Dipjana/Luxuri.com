...
export default function Miami(props){
                                    ...
                                    <Link to="/">
                                        <div className="dashboard-carousel-item-wrapper url-cursor" >
                                            <div className="property-image">
                                                <img src="https://res.cloudinary.com/ddlx05ofh/image/upload/v1613515781/woodendoor/1968953394Villa%20Rhodes.jpg.jpg" alt=""/>
                                            </div>
                                            <h5>Home</h5>
                                        </div>
                                    </Link>
